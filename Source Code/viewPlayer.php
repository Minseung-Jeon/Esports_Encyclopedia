<?php
// This file is the page for the viewPlayer page. This is where information on a "Player" is presented.
require("connect.php");
...
<main class="container-md">
    ...
    echo "<a href='deletePlayer.php?PlayerID=" . $playerID . "'><button class='btn btn-primary'>Delete</button></a>";
      }
    }
    ?>
